...
return new class extends Migration
{
    ...
    {
        Schema::create('importacoes_docentes', function (Blueprint $table) {
            $table->id();
            ...
            $table->text('outros_servicos_valor')->nullable();
            $table->text('outros_servicos_justificativa')->nullable();
            $table->text('outros_servicos_orcamento')->nullable();
    ...
    {
        Schema::dropIfExists('importacoes_docentes');
    }
};
